...
#else
	//for (u32 r = 1; r < WK; r+=2) {
	digitO << <totalblocks, threadsperblock >> >(device_eq, 1);
	digitE << <totalblocks, threadsperblock >> >(device_eq, 2);
	digitO << <totalblocks, threadsperblock >> >(device_eq, 3);
	digitE << <totalblocks, threadsperblock >> >(device_eq, 4);
	digitO << <totalblocks, threadsperblock >> >(device_eq, 5);
	digitE << <totalblocks, threadsperblock >> >(device_eq, 6);
	digitO << <totalblocks, threadsperblock >> >(device_eq, 7);
	digitE << <totalblocks, threadsperblock >> >(device_eq, 8);
