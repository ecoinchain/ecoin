    ...
    platformStyle(_platformStyle)
{
    ...
    modalOverlay = new ChainSyncWarning(this->centralWidget());
#ifdef ENABLE_WALLET
    if(enableWallet) {
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new IconedAction(platformStyle->ModedIcon(":/icons/overview"), tr("&Overview"), this);
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a %1 address").arg(tr(QAPP_COIN_NAME)));
    sendCoinsAction->setToolTip(sendCoinsAction->statusTip());
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    sendCoinsMenuAction = new QAction(platformStyle->TextColorIcon(":/icons/send_active"), tr("&Send"), this);
    sendCoinsMenuAction->setStatusTip(sendCoinsAction->statusTip());
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    receiveCoinsAction = new IconedAction(platformStyle->ModedIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and %1 URIs)").arg(QAPP_COIN_NAME_URI_SCHEME));
    receiveCoinsAction->setToolTip(receiveCoinsAction->statusTip());
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    receiveCoinsMenuAction = new QAction(platformStyle->TextColorIcon(":/icons/receiving_addresses_active"), tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(receiveCoinsAction->statusTip());
    receiveCoinsMenuAction->setToolTip(receiveCoinsMenuAction->statusTip());

    historyAction = new IconedAction(platformStyle->ModedIcon(":/icons/history"), tr("&Transactions"), this);
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/bitcoin"), tr("&About %1").arg(tr(PACKAGE_NAME)), this);
    ...
    toggleHideAction = new QAction(platformStyle->TextColorIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your %1 addresses to prove you own them").arg(tr(QAPP_COIN_NAME)));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified %1 addresses").arg(tr(QAPP_COIN_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%1 active connection(s) to network").arg(count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr(QAPP_ORG_NAME); // default title
