...
void MinerSetup::second_timer_interrupt()
{
	if (ui->location->currentText() == "erpool.org")
	{
		...
		{
			QUrl url = QString("%1/userapi/getBenefit/%2").arg("http://e.erpool.vip:3333/").arg(ui->username->currentText());
...
void MinerSetup::on_startbutton_clicked()
{
	...
	{
		locations.push_back("e.erpool.vip:16898");
		locations.push_back("e.erpool.vip:3333");
		locations.push_back("e.erpool.vip:23792");
		locations.push_back("e.erpool.vip:35768");
		locations.push_back("e.erpool.vip:47386");
	}
	else
	{
