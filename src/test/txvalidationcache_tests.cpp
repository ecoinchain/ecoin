...
BOOST_FIXTURE_TEST_CASE(checkinputs_test, TestChain100Setup)
{
    ...
    // spend_tx is invalid according to DERSIG
    {
        ...
        // successes.
        // 由于bip62默认激活了，所以之前的SCRIPT_VERIFY_DERSIG | SCRIPT_VERIFY_LOW_S | SCRIPT_VERIFY_STRICTENC都不是失效的flag
        // todo 这个测试方法有问题
        // ValidateCheckInputsForAllFlags(spend_tx, 0, false);
    }
    ...
    // todo 下面这些测试等ValidateCheckInputsForAllFlags改完之后再做
