...
bool cuda_djezo::solve(const char *tequihash_header,
...
{
	return device_context.context->solve(tequihash_header,
...
bool eq_cuda_context_interface::solve(const char *tequihash_header,
	unsigned int tequihash_header_len,
	const char* nonce,
	unsigned int nonce_len,
	std::function<bool()> cancelf,
